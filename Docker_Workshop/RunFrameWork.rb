...
class AutomationTest
    ...
    def navigate()
        puts testObject.navigate_to_browser(url)
        puts testObject.maximize_browser()
        puts testObject.get_browser_title()
    ...
    def search_Product()
        ...
        wait_for = testObject.explicit_wait(10)
        element = wait_for.until{testObject.find_web_element({:xpath=> '//*[@id="shopify-section-footer"]/footer/div[1]/div/div[2]/div/ul/li[1]/a'})}
        ...
        testObject.wait(wait_seconds)
        add_to_cart = testObject.find_web_element({:xpath=> '//*[@id="product_form_6146933686422"]/div[3]/div/button'})
        testObject.click_button(add_to_cart)
        testObject.wait(wait_seconds)
        buy_now = testObject.find_web_element({:xpath=> '//*[@id="product_form_6146933686422"]/div[3]/div/div/div/div/div/button[1]'})
